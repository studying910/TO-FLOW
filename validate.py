    ...
    with torch.no_grad():
        ...
        if args.validate:
            ...
            for i, (x, y) in enumerate(test_loader):
                ...
                z, delta_logp = model(xdirty, zero, integration_times=integration_times)  # run model forward
                ...
                z, delta_logp = model(xclean, zero, integration_times=integration_times)  # run model forward
        ...
        if args.generate:
            ...
            for t in [1., 0.9, 0.8, 0.7, 0.6, 0.5]:
                ...
                generated_samples = model(t * fixed_z, reverse=True, integration_times=integration_times_sample)
